...
import bonzoLogo from '../../assets/images/logos/dao/Bonzo_Dark.png';
...
const CORE_PROGRAMS: DesktopProgramGroup[] = [
  {
    ...
    programs: [
      ...
      },
      {
        id: 'bit-domains',
        label: '.bit Domains',
        description: 'Secure your decentralized identity.',
        route: '/bit-domains',
        accent: 'from-brand-orange via-brand-purple to-brand-blue',
