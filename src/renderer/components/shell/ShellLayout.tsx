...
const ShellLayout: React.FC = () => {
  ...
  const activeWindowKey = resolveWindowFromPath(location.pathname);
  const isBrowserRoute = activeWindowKey === 'browser';
      ...
      <div className='relative z-10 flex h-screen flex-col'>
        ...
        >
          ...
          >
            ...
            <span className='leading-none'>Hashgraph Online</span>
          </button>
        ...
        <main
          className={cn(
            ...
            isBrowserRoute ? 'relative overflow-hidden' : 'overflow-y-auto'
          )}
        >
          {isBrowserRoute ? (
            ...
            <div
              className={cn(
                'min-h-full transition-all duration-300 flex flex-col',
                isDark ? 'bg-transparent' : 'bg-white/60'
              )}
            >
              <div className='flex-1 px-6 pt-6 pb-14 md:px-12 lg:px-14'>
                <Outlet />
              </div>
            </div>
          )}
        ...
        <ShellTaskbar
          currentTimeLabel={formattedTime}
