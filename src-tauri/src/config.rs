...
pub struct SwarmConfig {
    ...
    #[serde(rename = "deferredUploadSizeThresholdMB")]
...
pub struct SwarmEnvironment {
    ...
    #[serde(rename = "beeFeedPK", skip_serializing_if = "Option::is_none")]
    pub bee_feed_pk: Option<String>,
    #[serde(skip_serializing_if = "Option::is_none")]
    pub auto_assign_stamp: Option<bool>,
    #[serde(rename = "deferredUploadSizeThresholdMB", skip_serializing_if = "Option::is_none")]
